...
public class Juego extends InterfaceJuego {
	...
	private int cantMurcielagos = 10;// Cantidad máxima de murciélagos en pantalla
	private String mensajeManá = "";
	private int timerMensaje = 0;
	private final int totalMurcielagos = 50;// Cantidad total de murciélagos
	...
	Juego() {
		...
		Herramientas.cargarSonido("prize.wav");
